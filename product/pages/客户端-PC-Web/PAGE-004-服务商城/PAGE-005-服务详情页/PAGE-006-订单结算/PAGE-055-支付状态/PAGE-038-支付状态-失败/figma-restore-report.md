# PAGE-038 - 支付状态-失败 Figma Restore Report

## 基本信息

- 源 JSON：`product/pages/客户端-PC-Web/PAGE-004-服务商城/PAGE-005-服务详情页/PAGE-006-订单结算/PAGE-055-支付状态/PAGE-038-支付状态-失败/figma-nodes.json`
...
- 最新根画板：`PAGE-038 - 支付状态-失败 - PC Web (2)`
- 最新根节点 ID：`266:2`
- 既有对比画板：`PAGE-038 - 支付状态-失败 - PC Web` / `257:134`，已保留未覆盖
...
| 区域 | 结果 | 说明 |
| --- | --- | --- |
| `PaymentStatusResult` | pass | 支付失败状态、订单编号、失败说明 |
| `OrderSummary` | pass | 服务名称、支付方式、订单号、支付金额 |
| `StatusActions` | pass | 重新支付、返回订单 |
...
- 最新截图 URL：`https://www.figma.com/api/mcp/asset/edb0b0f4-d50c-4fd2-b78b-2e04a2ba5b12`
- 历史截图 URL：`https://www.figma.com/api/mcp/asset/0afbf498-9bbc-48e5-9d17-13ede57c0e5e`

## 追加历史

| 时间 | 根画板 | 根节点 ID | Figma 链接 | QA |
| --- | --- | --- | --- | --- |
| 2026-05-19 | `PAGE-038 - 支付状态-失败 - PC Web` | `257:134` | https://www.figma.com/design/ZP4TjUsWJyHncnukJuVfRD/Agent-Test?node-id=257-134&t=A760mTWqS5Qcfqy5-1 | pass |
| 2026-05-19 | `PAGE-038 - 支付状态-失败 - PC Web (2)` | `266:2` | https://www.figma.com/design/ZP4TjUsWJyHncnukJuVfRD/Agent-Test?node-id=266-2&t=A760mTWqS5Qcfqy5-1 | pass |
